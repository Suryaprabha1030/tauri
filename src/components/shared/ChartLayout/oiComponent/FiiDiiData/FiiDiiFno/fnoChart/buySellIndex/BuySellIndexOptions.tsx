...
const BuySellIndexOptions = (
  ...
  const allValues = [...callChg, ...putChg];
  ...
  const fontSize = width < 40 ? "10px" : "12px";
  ...
  return {
    ...
    xaxis: {
      categories: XAxisValue.map((date) => date.replace(/-/g, " ")),
...
export default BuySellIndexOptions;
