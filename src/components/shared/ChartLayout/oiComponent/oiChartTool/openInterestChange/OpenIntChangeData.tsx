const OpenIntChangeData = (data: any) => {
  ...
  data.forEach((item: any) => {
    ...
    if (item.option_type === "CE") {
      strikePriceMap[item.strike_price].call = item.oi_change;
    } else if (item.option_type === "PE") {
      strikePriceMap[item.strike_price].put = item.oi_change;
    }
  });
...
export default OpenIntChangeData;
