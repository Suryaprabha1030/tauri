const SorryModal = (props: { totalValue: number; hideModal: () => void }) => {
  return (
    <div
      id="popup-modal"
      className="fixed left-0 right-0 top-0 z-50 flex max-h-full max-sm:max-h-full items-center max-sm:items-center max-sm:justify-center justify-center overflow-x-hidden bg-gray-500 bg-opacity-60 p-4 md:inset-0"
    >
